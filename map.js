...
const layers = {
  ...
  l5: L.layerGroup().addTo(map),  // Space & Science (Lớp mới)
  l6: L.layerGroup().addTo(map),  // Logistics (Lớp mới)
};

const layerState = { 1:true, 2:true, 3:true, 4:true, 5:true, 6:true };
...
function updateTicker(year) {
  ...
  if (year === 1986) {
    ...
    inner.innerHTML = `
      ...
      <span class="ticker-sep">◆</span>
      ❄️ Khoa học cực địa – các nhà nghiên cứu Việt Nam cắm cờ Tổ quốc và tham gia đoàn nghiên cứu tại Nam Cực
      <span class="ticker-sep">◆</span>
      📡 Viettel đang hoạt động tại 13 quốc gia với 50+ triệu thuê bao quốc tế
      <span class="ticker-sep">◆</span>
      🎗️ Quân đội nhân dân VN tham gia GGHB LHQ tại Nam Sudan &amp; CH Trung Phi
      <span class="ticker-sep">◆</span>
      🍜 Phở &amp; Cà phê Việt Nam có mặt tại hơn 140 quốc gia
      <span class="ticker-sep">◆</span>
      🏗️ VinFast mở nhà máy tại Mỹ, Ấn Độ và Châu Âu
    `;
  }
}
